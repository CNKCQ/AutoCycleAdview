...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    it's a custom view, you can use it to display AD
                   DESC
  ...
  s.source       = { :git => "https://github.com/CNKCQ/AutoCycleAdview.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "AutoCycleAdview", "AutoCycleAdview/**/*.{h,m,swift}"
  s.exclude_files = "AutoCycleAdview/Exclude"
